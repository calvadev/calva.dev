  ...
  return (
    <div className="w-full h-full p-3">
      ...
      <div className="w-1/2 mx-auto my-4">
        <img alt="" src="../../bitcoin-and-the-lightning-network.jpg" />
      </div>
      <h1 className="py-2 px-3 text-xl">
        <strong>Bitcoin vs Banks</strong>
      </h1>
      <p className="ml-3 mb-6">
        Since 1949, banks have robbed merchants by skimming off the top of every
        payment made through their systems, leaving merchants to bear the cost
        and consumers to pay the price. This thievery is achieved through the
        use of payment processors, or payment networks, such as Visa and
        Mastercard, that charge large fees for the use of their systems to
        process and settle payments. These fees lead to merchants taking a hit
        on their revenue, causing them to raise prices and possibly switch to
        cash and coins to avoid payment processors altogether. Consumers are
        then left inconvenienced and with a bigger bill than they should have
        gotten. Thankfully, Bitcoin has provided us with a solution: the
        Lightning Network.
      </p>
      <p className="ml-3 mb-6">
        Not only has bitcoin
        <sup id="reference-1">
      ...
      <p className="ml-3 mb-6">
        An on-chain transaction can take hours to be sent and confirmed, which
        is desired for large transactions, like purchasing a house, to ensure
        the funds are received safely, but can be very tedious for a small
        transaction, such as buying a $5 cup of coffee. With the Lightning
        Network, your payment for that cup of coffee can be sent, confirmed, and
        settled instantly, at virtually no cost, all while still ensuring the
        validity of the transaction.
      </p>
      <p className="ml-3 mb-6">
        With a payment system tied to banks, it can take days, if not months,
        for a payment to be confirmed and settled in the bank account of the
        merchant, regardless of whether a credit card, wire transfer, check, or
        other form of payment was used. Our current payment system forces us to
        depend on a third party to access our own money, have all of our
        purchases tied to our personal identity, and deal with ridiculous fees
        that only serve to line the pockets of bankers. The Lightning Network
        enables us to take complete control of our money, reduce the cost of
        goods and services, increase personal privacy, and accelerate societal
        advancement.
      </p>
      <h1 className="py-2 px-3 text-xl">
        <strong>El Salvador&apos;s Adoption</strong>
      </h1>
      <p className="ml-3 mb-6">
        March of this year was the first time I ever stepped foot in Central
        America. On top of that, it was the first time I ever stepped foot in a
        country that has adopted bitcoin as legal tender: El Salvador. I didn’t
        know what to expect when I got off my flight, but I knew I wanted to try
        living solely off of bitcoin and the Lightning Network for the time I
        would be there.
      </p>
      <p className="ml-3 mb-6">
        If you come to El Salvador with the same goal I had, you’ll immediately
        have the chance to put yourself to the test. Before leaving the airport,
        you’re required to purchase a $12 tourist card, and with the country
        having adopted a new digital currency as legal tender, of course you
        have the option to pay in bitcoin. Here is where I ran into my first
        roadblock: the attendant didn’t know how to request a Lightning payment
        and instead requested an on-chain payment.
      </p>
      <p className="ml-3 mb-6">
        I explained to her that she was creating a request for the wrong type of
        payment, but she wasn’t too familiar with how to operate the Chivo
      ...
      <p className="ml-3 mb-6">
        I stayed with several friends of mine and mainly spent time in El Tunco,
        Santa Tecla, and San Salvador. I had the opportunity to try and pay in
        bitcoin at restaurants, bars, and with street vendors. Only once was I
        successfully able to purchase food and drinks from a restaurant using a
        Lightning payment. Granted, when we were there, my friends and I would
        put everything on one bill and split the cost after, but at almost every
        place we went to, I asked if they accepted bitcoin. Only about half of
        the restaurants said they accepted the digital currency; no bars or
        street vendors took it as payment.
        <sup id="reference-2">
          <a href="#footnote-2">2</a>
        </sup>
      </p>
      <p className="ml-3 mb-6">
        I had come to El Salvador just assuming that Bitcoin adoption would be
        widespread and prominent across the country, but I was mistaken. People
        appeared to be more weary of using it than I thought, but with good
        reason. The volatility in the price of bitcoin is definitely something
        that exposes its users to the risk of having less of their local
        currency from one minute to the next (with the flip side of having more
        money over the long run as well).
      </p>
      <p className="ml-3 mb-6">
        The thing to realize is that regardless of bitcoin’s dollar price, the
        Bitcoin network allows its users to freely transact with anyone in the
        world over an open, decentralized monetary system that is truly
        peer-to-peer. By adopting bitcoin as legal tender, citizens of El
        Salvador have a way to escape a dollarized system controlled by a
        foreign government that does not care about what is best for people
        living in El Salvador; the American government hardly even considers its
        own citizens. The U.S. has typically acted in its own self-interest,
        disregarding the devaluation of the savings of the people it governs
        when it runs the money printer to finance bloated government programs
      ...
      <p className="ml-3 mb-6">
        ...
        have to be more considerate of their use of the currency and not just
        throw their money at any random ideas they think might have a chance at
        success.
      </p>
      <p className="ml-3 mb-6">
        Moreover, in a fiat currency system backed by the U.S. dollar, people
        holding onto it as cash have had their purchasing power decrease on
        average by about 7% annually for the last 100 years due to the expansion
        of the money supply by the Federal Reserve. This is seen in the
        increased cost of housing, food, education, health care, and other
      ...
      <p className="ml-3 mb-6">
        ...
        of assets without increasing the purchasing power of the holders of
        those assets in real terms. The price of a share of stock may go from
        $100 to $200, but by the time it reaches that price, $200 may not go as
        far as it once did, especially for someone who lives paycheck to
        paycheck.
      </p>
      <p className="ml-3 mb-6">
        ...
        of Bitcoin, the network has stayed running smoothly and is only getting
        bigger.
      </p>
      <p className="ml-3 mb-6">
      ...
      <p className="ml-3 mb-6">
        ...
        , everyone would be instantly more capable and willing to try out the
        technology.
      </p>
      <p className="ml-3 mb-6">
      ...
      <p className="ml-3 mb-6">
        ...
        the world, allowing anyone to purchase and spend it anywhere that there
        is an internet connection. Bitcoin allows for more financial inclusion,
        and in a place that has the proper technological infrastructure and
        understanding, it can easily thrive and overtake any competition as
        merchants and consumers come to learn the benefits it provides for its
        users.
      </p>
      <h1 className="py-2 px-3 text-xl">
      ...
      <p className="ml-3 mb-6">
        Bitcoin still has a long way to go before it’s fully embraced by the
        public. More education has to be put in place to teach people how to use
        Bitcoin and Lightning technology, and the price has to stabilize or
        continue to appreciate in order for more people to be drawn to it as an
      ...
      <p className="ml-3 mb-6">
        ...
        Blackhawk and NCR, the world&apos;s largest point-of-sale provider, that
        is planned to be rolled out before the end of the year. That means that
        ...
        <ol className="list-decimal">
          <a href="#reference-1">
            <li id="footnote-1" className="mb-3">
              <em>
                When ‘Bitcoin’ is capitalized, I am referring to the concept and
                network. When ‘bitcoin’ is lowercase, I am referring to the
          ...
          <a href="#reference-3">
            <li id="footnote-3" className="mb-3">
              <em>
                I would recommend using a Bitcoin or Lightning wallet that is
                ‘non-custodial,’ meaning you have ownership of your ‘private
                keys.’ This ensures that you have total control of your Bitcoin
                as only you can authorize and sign-off on a transaction. On top
                of that, any wallet on the network can interact with another, so
                there is no requirement to use a specific wallet when
                transacting.
              </em>
            </li>
          </a>
